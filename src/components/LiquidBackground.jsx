...
export function LiquidBackground() {
  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <div
        ref={blobRef}
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] sm:w-[360px] sm:h-[360px] lg:w-[500px] lg:h-[500px] rounded-full bg-gradient-to-r from-indigo-500/30 to-fuchsia-500/30 blur-[100px] mix-blend-screen ${
