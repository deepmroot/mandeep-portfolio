    ...
    <main className="min-h-screen bg-[#0a0b10] text-slate-200 font-sans selection:bg-indigo-500/30 relative">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col gap-4 max-w-2xl">
              ...
              <p className="text-sm md:text-base text-slate-400 max-w-xl leading-relaxed">
                Explore featured builds, core engineering work, and product experiments through a cleaner project browser.
              </p>
            </div>
          </div>
        </section>
                          ...
                          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#0d0e14] via-[#0a0b10] to-[#06070c] p-8">
                            ...
                            <div className="relative z-10 max-w-lg text-center">
                              ...
                              <button
                                ...
                                disabled={!flagshipLiveDemoHref}
                                className="inline-flex min-w-[190px] items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-indigo-500 text-white text-xs font-black uppercase tracking-[0.2em] shadow-[0_6px_0_rgb(30,58,138)] hover:brightness-110 active:translate-y-[3px] active:shadow-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                              >
        ...
        {shouldShowSelected && selectedProjects.map((project, index) => {
          ...
          const projectTagline = isOlive ? 'Global Sourcing Platform' : isRose ? 'Premium AI Access Layer' : 'AI Rental Operations Platform';
          const architectureTitle = isOlive ? 'Process Flow' : isRose ? 'Access Fabric' : 'Service Mesh';
          const architectureMeta = isOlive ? 'SUPPLY_CHAIN_AI // DISTRIBUTED_SOURCING' : isRose ? 'PREMIUM_AI_SAAS // BILLING_AUTH_ROUTING' : 'SAAS_UTILITY // AI_AGENT_SCREENING';
                ...
                <div className="max-w-7xl mx-auto px-6">
                  <div className={`flex flex-col mb-12 ${isInverted ? 'items-start text-left' : 'items-end text-right'}`}>
                    ...
                    <div className={`mb-8 flex flex-col gap-4 ${isInverted ? 'items-start' : 'items-end'} group/brand`}>
                        ...
                        {isOlive ? (
                          <div className={`flex flex-col ${isInverted ? 'items-start' : 'items-end'}`}>
                            <img
                              ...
                              loading="lazy"
                              decoding="async"
                              className="h-16 md:h-20 w-auto drop-shadow-2xl transition-transform duration-500 group-hover/brand:scale-[1.02]"
                            />
                          </div>
                        ) : isRose ? (
                            ...
                            {project.title === "RentSpace" && (
                              <div className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 shrink-0 relative z-10">
                                <img
                                  ...
                                  loading="lazy"
                                  decoding="async"
                                  className="w-full h-full object-contain drop-shadow-2xl transition-transform duration-500 group-hover/brand:scale-105"
                                />
                              </div>
                            )}
                      ...
                      <span className="text-[10px] font-mono uppercase tracking-[0.32em]" style={{ color: brandColor }}>
                        {projectTagline}
                      </span>
                    </div>
                              ...
                              <div className={`absolute inset-0 flex items-center justify-center p-8 ${isRose ? 'bg-gradient-to-br from-[#120b12] via-[#0a0b10] to-[#14060d]' : 'bg-gradient-to-br from-[#111317] via-[#0a0b10] to-[#070809]'}`}>
                                ...
                                <div className="relative z-10 max-w-md text-center">
                                  ...
                                  <button
                                    ...
                                    disabled={!selectedLiveDemoHref}
                                    className="inline-flex min-w-[190px] items-center justify-center gap-2 px-6 py-3.5 rounded-xl text-xs font-black uppercase tracking-[0.2em] shadow-[0_6px_0_rgba(15,23,42,0.55)] hover:brightness-110 active:translate-y-[3px] active:shadow-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                    style={{
                        ...
                        <div className="flex justify-between items-start mb-10 relative z-10">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <h3 className={`text-[10px] font-bold uppercase tracking-[0.4em]`} style={{ color: brandColor }}>{architectureTitle}</h3>
                            </div>
                            <p className="text-[7px] text-slate-600 font-mono tracking-[0.2em]">TYPE: {architectureMeta}</p>
                          </div>
                        </div>
                        ...
                        <div className={`relative flex items-center justify-between gap-3 h-28 px-6 rounded-2xl border shadow-inner transition-colors duration-500 ${isRose ? 'bg-[#130811] border-[#4b2231] shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]' : 'bg-black/60 border-white/5'}`}>
                          {isOlive ? (
                            <>
                              ...
                              <ArchitectureNode label="Matching" icon={<Cpu className="w-5 h-5" />} highlight color="olive" lowMotion={lowMotionMode} />
                              <ArchitectureLine color="olive" lowMotion={lowMotionMode} />
                              <ArchitectureNode label="Fulfillment" icon={<Database className="w-5 h-5" />} color="olive" lowMotion={lowMotionMode} />
                            </>
                          ) : isRose ? (
                            <>
                              <ArchitectureNode label="Models" icon={<Cpu className="w-5 h-5" />} color="rose" lowMotion={lowMotionMode} />
                              <ArchitectureLine color="rose" lowMotion={lowMotionMode} />
                              <ArchitectureNode label="Billing" icon={<Zap className="w-5 h-5" />} highlight color="rose" lowMotion={lowMotionMode} />
                              <ArchitectureLine color="rose" lowMotion={lowMotionMode} />
                              <ArchitectureNode label="Access" icon={<Globe className="w-5 h-5" />} color="rose" lowMotion={lowMotionMode} />
                            </>
                          ) : (
                            <>
                              <ArchitectureNode label="Listings" icon={<Layout className="w-5 h-5" />} color="orange" lowMotion={lowMotionMode} />
                              <ArchitectureLine color="orange" lowMotion={lowMotionMode} />
                              <ArchitectureNode label="Screening" icon={<ShieldCheck className="w-5 h-5" />} highlight color="orange" lowMotion={lowMotionMode} />
                              <ArchitectureLine color="orange" lowMotion={lowMotionMode} />
                              <ArchitectureNode label="Messaging" icon={<Cpu className="w-5 h-5" />} color="orange" lowMotion={lowMotionMode} />
                            </>
                          )}
                        </div>
                      </div>
                        ...
                        {project.links.map((link) => (
                          <a
                            ...
                            style={{
                              ...
                              boxShadow: (link.label.includes('Demo') || link.label === 'Site') ? `0 6px 0 ${shadowColor}` : undefined,
...
function TopHeader({ projectFilter, projectFilterOptions, isFilterMenuOpen, setIsFilterMenuOpen, setProjectFilter, filterMenuRef }) {
  const [activeNav, setActiveNav] = useState("Home");
  const navItems = [
    { label: "Home", href: "#top" },
    { label: "Selected", href: "#flagship" },
    { label: "Core", href: "#core-projects" },
    { label: "Lab", href: "#additional-projects" },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-3 lg:grid lg:grid-cols-[1fr_auto_1fr] lg:items-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <div className="hidden lg:flex items-center gap-1 rounded-full border border-white/5 bg-[#070c19] px-1.5 py-1">
              {navItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full px-4 py-2 text-[13px] font-semibold transition-all ${
                      isActive
                        ? "text-sky-400 bg-sky-400/10 shadow-[inset_0_0_0_1px_rgba(56,189,248,0.14)]"
          ...
          <div className="flex flex-col sm:flex-row gap-2 lg:items-center lg:justify-self-end">
            <div className="hidden lg:block">
              <GlobalSearch
                renderTrigger={({ onClick }) => (
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold uppercase tracking-[0.18em]">Search Projects</span>
